 ...
 */
@ArcadiaComponent(componentname = "Component22",componentversion = "0.0.1",componentdescription = "A dummy intermediate component",tags={"dummy","middle"})
...
public class Component {
    ...
    */
    ...
    public static void  bindedRootComponent(ChainingInfo chainingInfo){
        logger.info("BINDED DUMMY ROOT COMPONENT:"+chainingInfo.toString());
    }
